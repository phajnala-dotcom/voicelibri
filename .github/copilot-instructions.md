...
**NEVER IMPOSE ARTIFICIAL LIMITS, CAPS, THRESHOLDS, OR DEFAULT VALUES ON SYSTEM BEHAVIOR UNLESS TECHNICALLY INEVITABLE (e.g., API hard limits).**

**NEVER INVENT SYSTEM SETTINGS, CONFIGURATION DEFAULTS, OR PROCESSING CONSTRAINTS THAT WERE NOT EXPLICITLY REQUESTED BY THE USER.**

**IF A LIMIT OR DEFAULT SEEMS REASONABLE, ASK FOR USER APPROVAL FIRST — DO NOT SET IT ON YOUR OWN.**

---

# ⚠️ MANDATORY DIRECTIVE - ANALYSIS BEFORE ACTION

**WHEN THE USER ASKS QUESTIONS OR RAISES CONCERNS ABOUT ARCHITECTURE, DESIGN, OR IMPLEMENTATION:**

**1. ANALYZE AND PRESENT FINDINGS FIRST — NEVER START IMPLEMENTING CHANGES.**

**2. CLEARLY STATE YOUR SUGGESTED SOLUTION(S) AND WAIT FOR EXPLICIT USER APPROVAL.**

**3. ONLY AFTER THE USER APPROVES A SPECIFIC SOLUTION, PROCEED WITH IMPLEMENTATION.**

**THIS APPLIES TO ALL DESIGN DISCUSSIONS, SPEC CHANGES, AND ARCHITECTURE DECISIONS — EVEN IF A FIX SEEMS OBVIOUS.**
